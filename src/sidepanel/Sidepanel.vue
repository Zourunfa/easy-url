...
const currentOpenxHeaderObj = ref(undefined)
...
<template>
  <main class="w-full text-center">
    <div class="text-center w-90% p-4">
      <textarea
        v-model="currentUrl"
        class="w-full h-48 resize-none p-2 border border-gray-300 rounded-md bg-white text-gray-700 focus:outline-none focus:border-blue-500"
      />
      <!-- <textarea
